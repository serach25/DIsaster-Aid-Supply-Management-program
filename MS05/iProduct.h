...
namespace ama {
	...
	class iProduct {
	public:
		virtual std::ostream& write(std::ostream& os, int writeMode) const = 0;  // implemented in class Product
		virtual std::istream& read(std::istream& is, bool interractive) = 0; //implemented in Product
		...
		virtual ~iProduct() {};  //interface should include a virtual empty-body destructer
